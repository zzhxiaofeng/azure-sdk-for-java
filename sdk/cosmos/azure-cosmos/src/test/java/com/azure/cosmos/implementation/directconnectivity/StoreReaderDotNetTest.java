...
public class StoreReaderDotNetTest {
    ...
    public void storeClient() throws URISyntaxException {
        ...
        entity.getHeaders().CONSISTENCY_LEVEL = ConsistencyLevel.BOUNDED_STALENESS.toString();
        ...
        Mockito.when(mockAuthorizationTokenProvider.getUserAuthorizationToken(Matchers.anyString(), Matchers.any(), Matchers.any(RequestVerb.class), Matchers.any(HttpHeaders.class),
    ...
    public void globalStrongConsistentWrite() {
        ...
        // set consistency level on the request to Bounded Staleness
        entity.getHeaders().CONSISTENCY_LEVEL = ConsistencyLevel.STRONG.toString();
